    ...
    <div class="principal-container-page">
        ...
        <nav class="navigation-menu-container">
            ...
            <ul class="list-unstyled text-center">
                ...
                <li><a class="all-titles-pages" href="news.html">Noticias</a></li>
                <li><a class="all-titles-pages" href="galery.html">Galeria</a></li>
                <li><a class="all-titles-pages" href="maestros.html">Maestros</a></li>
		...
		<div class="content-container-page">
            ...
            <div class="jumbotron">
              <h1 class="all-titles-pages">Acerca de MusicStore</h1>
              <p>
              ...
              <p>
                <span class="label label-danger">2014</span>&nbsp; Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor perspiciatis distinctio soluta commodi numquam eveniet, eius et rerum deleniti, deserunt pariatur veritatis, unde modi voluptatem impedit recusandae eum reiciendis repellat!
              </p>
              <p>
                <span class="label label-danger">2013</span>&nbsp; Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor perspiciatis distinctio soluta commodi numquam eveniet, eius et rerum deleniti, deserunt pariatur veritatis, unde modi voluptatem impedit recusandae eum reiciendis repellat!
              </p>
              <p>
                <span class="label label-danger">2012</span>&nbsp; Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor perspiciatis distinctio soluta commodi numquam eveniet, eius et rerum deleniti, deserunt pariatur veritatis, unde modi voluptatem impedit recusandae eum reiciendis repellat!
              </p>
            </div>
            ...
            <footer>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <h3 class="text-center all-titles-pages">MusicStore &copy; 2016</h3><br>
                        </div>
                    </div>
                </div>
            </footer>
